...
function handleButtonClick(buttonID) {
  ...
  button.addEventListener("click", function () {
    ...
    if (roundResult === "Win") {
      ...
      resultRoundResult.classList.remove("lost", "drew");
      resultRoundResult.classList.add("won");
    } else if (roundResult === "Lose") {
      rivalScore += 1;
      roundsLost += 1;
      resultRoundResult.textContent = "LOST";
      resultRoundResult.classList.remove("won", "drew");
      resultRoundResult.classList.add("lost");
    } else {
      roundsDrawn += 1;
      resultRoundResult.textContent = "DREW";
      resultRoundResult.classList.remove("won", "lost");
      resultRoundResult.classList.add("drew");
    }
    checkScores();
...
Old Code, HandleButtonClick Is Breaking Alignment When Scores And Round Display:
